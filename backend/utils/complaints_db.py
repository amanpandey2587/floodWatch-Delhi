...
from utils.complaints import (
    ComplaintStatus, ComplaintPriority, ComplaintCreate, 
    ComplaintUpdate, ComplaintRating
)
from models import ComplaintModel
from utils.notifications import create_notification_for_ward_admin, create_complaint_status_notification
from typing import Optional, List, Dict, Any
from datetime import datetime
from utils.image_verification import verify_images_batch, get_verification_summary
import uuid
...
def get_complaint_by_id(complaint_id: str) -> Optional[dict]:
    ...
    if complaint:
        ...
        from utils.sla_helper import calculate_sla_status
